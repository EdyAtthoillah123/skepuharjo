                                                        ...
                                                        <form action="pdfsktm.php" method="post">
                                                            ...
                                                            <div class="modal fade" id="PreviewsktmModal<?php echo $row['id_akun']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog modal-lg modal-dialog-centered" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <!-- <form action="pdfsktm.php" method="post"> -->
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="sktm" class="form-control" value="<?php echo $row['id_surat']; ?>" maxlength="50" required="">
                                                                                <span class="text-danger">
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="hidden" name="idsktm" value="<?php echo $row['id_surat']; ?>" />
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <?php echo "<a href='Api/pdf/document.pdf'>Download PDF</a>"; ?>
